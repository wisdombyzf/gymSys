        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    <a href="#">
                        <i class="fa fa-edit"></i> <span>裁判界面选择</span>
                        <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="firstJudgerIndex.jsp"><i class="fa fa-circle-o"></i> 总裁判界面 </a></li>
                        <li><a href="judgerIndex.jsp"><i class="fa fa-circle-o"></i> 分裁判界面 </a></li>
                    </ul>
                </li>
