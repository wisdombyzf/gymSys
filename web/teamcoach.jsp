        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-body">
              ...
              <table id="teamcoach" class="table table-bordered table-striped">
              </table>
            </div>
            <!-- /.box-body -->
          </div>
...
<script>
  $.selectArray =
    {
      "fields.Gender": [{idxNum: '',name: 'M'}, {idxNum: '',name: 'F'}]
    };
  ...
  $(function () {
      $('#delete').click(function () {
          var pk = $.map($("#teamcoach").bootstrapTable('getSelections'), function (row) {
              return row.pk;
          });
          $.post("Set",{
            Type:"Delete",
          ...
          $("#teamcoach").bootstrapTable('refresh')
          )
      });
    });
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" method="post" action="Set">
            ...
            <div class="form-group" style="display:none">
                ...
                <div class="col-sm-6"><input required type="text" class="form-control input-md" id="Table" name="Table" value="TeamCoach"></div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select class="form-control selectpicker show-tick" id="Gender" name="Gender">
