        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-body">
              ...
              <table id="teammedic" class="table table-bordered table-striped">
              </table>
            </div>
            <!-- /.box-body -->
          </div>
...
<script>
  $(function () {
    $('#teammedic').bootstrapTable({
      url: "http://"+window.location.hostname+":8080/get_mdeic",
      clickEdit: true,
      pagination:true,
      search:true,
      showRefresh:true,
  ...
  $(function () {
      $('#delete').click(function () {
          var pk = $.map($("#teammedic").bootstrapTable('getSelections'), function (row) {
              return row.pk;
          });
          $.post("Set",{
            Type:"Delete",
          ...
          $("#teammedic").bootstrapTable('refresh')
          )
      });
    });
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal" method="post" action="Set">
            ...
            <div class="form-group" style="display:none">
                ...
                <div class="col-sm-6"><input required type="text" class="form-control input-md" id="Table" name="Table" value="TeamMedic"></div>
            </div>
